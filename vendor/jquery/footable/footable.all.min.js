...
(function (e, t) {
    ...
    t.footable = {
        options: {
            ...
            major: 0, minor: 10, toString: function () {
...
;(function (e, t, undefined) {
    function a() {
        ...
        t.name = "Footable Filter", t.init = function (a) {
            ...
            var i = t.footable, o = e(i.table), n = o.data("filter-minimum") || i.options.filter.minimum, r = !a,
    ...
    var i = {
        filter: {
            ...
            filterFunction: function () {
                var t = e(this), a = t.parents("table:first"), i = a.data("current-filter").toUpperCase(),
                    o = t.find("td").text();
    ...
    function a() {
        ...
        t.name = "Footable Sortable", t.init = function (a) {
            ...
            if (e(o.table).data("sort") !== !1) {
                var n = e(o.table), r = n.find("> tbody"), l = o.columns[a],
        ...
        t.name = "Footable LucidBookmarkable", t.init = function (t) {
            t.options.bookmarkable.enabled && e(t.table).bind({
                footable_initialized: function () {
                    var i = t.table.id, o = a(i + "_f"), n = a(i + "_p"), r = a(i + "_s"), l = a(i + "_d"),
                        s = a(i + "_e");
                    if (o) {
                ...
                "footable_page_filled footable_redrawn footable_filtered footable_sorted footable_row_expanded footable_row_collapsed": function (a) {
                    if (i(t, a), t.lucid_bookmark_read) {
                        var o = t.table.id, n = o + "_f", r = o + "_p", l = o + "_s", s = o + "_d", d = o + "_e",
                            f = location.hash.replace(/^\#/, "&"), p = [n, r, l, s, d];
                        for (var u in p) {
                            var g = RegExp("&" + p[u] + "=([^&]*)", "g");
                            f = f.replace(g, "")
                        }
